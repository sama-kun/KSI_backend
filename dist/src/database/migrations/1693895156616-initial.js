...
exports.Initial1693895156616 = void 0;
class Initial1693895156616 {
    constructor() {
        this.name = 'Initial1693895156616';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TYPE "public"."project_status_enum" AS ENUM('planned', 'active', 'finished')`);
        await queryRunner.query(`CREATE TABLE "project" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying NOT NULL, "description" character varying, "status" "public"."project_status_enum" NOT NULL DEFAULT 'planned', "updatedById" integer, "createdById" integer, CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cart-item" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "quantity" integer, "initialQuantity" integer, "isHistory" boolean NOT NULL DEFAULT false, "returnTime" TIMESTAMP WITH TIME ZONE, "workedHours" integer, "status" character varying NOT NULL DEFAULT 'OnProject', "updatedById" integer, "createdById" integer, "itemId" integer, "projectId" integer, CONSTRAINT "PK_0bab23e63a695e02f3b9496809b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "maintenance" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "checkDate" date, "updatedById" integer, "createdById" integer, "itemId" integer, "checkerId" integer, CONSTRAINT "PK_542fb6a28537140d2df95faa52a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "file" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "url" character varying NOT NULL, "secure_url" character varying NOT NULL, "asset_id" character varying NOT NULL, "public_id" character varying NOT NULL, "folder" character varying, "type" "public"."file_type_enum" NOT NULL DEFAULT 'image', "updatedById" integer, "createdById" integer, "itemId" integer, CONSTRAINT "PK_36b46d232307066b3a2c9ea3a1d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "cart-item" ADD CONSTRAINT "FK_a04cf8c2e30121c26978bd25bcb" FOREIGN KEY ("itemId") REFERENCES "item"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cart-item" ADD CONSTRAINT "FK_79983fb48ec5b3138c2c3f1064b" FOREIGN KEY ("projectId") REFERENCES "project"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "cart-item" DROP CONSTRAINT "FK_79983fb48ec5b3138c2c3f1064b"`);
        await queryRunner.query(`ALTER TABLE "cart-item" DROP CONSTRAINT "FK_a04cf8c2e30121c26978bd25bcb"`);
...
exports.Initial1693895156616 = Initial1693895156616;
//# sourceMappingURL=1693895156616-initial.js.map