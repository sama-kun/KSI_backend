...
export class Initial1695642772761 implements MigrationInterface {
  name = 'Initial1695642772761';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "item_cart_items_cart-item" ("itemId" integer NOT NULL, "cartItemId" integer NOT NULL, CONSTRAINT "PK_1e1a563cd63f42461482e6e90dc" PRIMARY KEY ("itemId", "cartItemId"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_730e7e2f7479b8f184e6c84078" ON "item_cart_items_cart-item" ("itemId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_4a41fbc4aea80fc4c6a55d13f0" ON "item_cart_items_cart-item" ("cartItemId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "item_cart_items_cart-item" ADD CONSTRAINT "FK_730e7e2f7479b8f184e6c840781" FOREIGN KEY ("itemId") REFERENCES "item"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "item_cart_items_cart-item" ADD CONSTRAINT "FK_4a41fbc4aea80fc4c6a55d13f0c" FOREIGN KEY ("cartItemId") REFERENCES "cart-item"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "item_cart_items_cart-item" DROP CONSTRAINT "FK_4a41fbc4aea80fc4c6a55d13f0c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "item_cart_items_cart-item" DROP CONSTRAINT "FK_730e7e2f7479b8f184e6c840781"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4a41fbc4aea80fc4c6a55d13f0"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_730e7e2f7479b8f184e6c84078"`,
    );
    await queryRunner.query(`DROP TABLE "item_cart_items_cart-item"`);
