...
export class BasemodelChange1691439716089 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "image" ADD CONSTRAINT "FK_e6e73444b9ef8d8fd71dceeccd2" FOREIGN KEY ("updatedById") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "image" DROP CONSTRAINT "FK_e6e73444b9ef8d8fd71dceeccd2"`,
    );
    await queryRunner.query(
